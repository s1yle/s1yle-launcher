...
│   │   ├── InstanceList.tsx        # 实例列表（带二级侧边栏）
│   │   ├── InstanceManage.tsx      # 实例管理
│   │   ├── GameSettings.tsx        # 全局游戏设置
│   │   ├── GameSettingsJava.tsx    # Java 管理
│   │   ├── GameSettingsGeneral.tsx # 通用设置
│   │   ├── GameSettingsAppearance.tsx # 外观设置
│   │   ├── GameSettingsDownload.tsx # 下载设置
│   │   └── ...
│   ├── router/
