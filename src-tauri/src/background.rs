...
use crate::{app_context::AppContext, log_info};

/// 通过系统文件选择器选择背景图片，并复制到应用数据目录
#[tauri::command]
pub async fn select_background_image(app_ctx: State<'_, AppContext> ,app: AppHandle) -> Result<Option<String>, String> {
